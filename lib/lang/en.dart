const Map<String, String> EN_LANG = {
  ...
  "upName": 'Wallet name up to 20 characters',
  "walletName": "Wallet name",
  'placeholderWalletName': '1-20 characters',
  ...
  "strengthTips": 'It contains numbers, upper and lower case letters and special characters, and the password reaches the strongest level',
  "levelTips": "For your account security, please set the password to the strongest level",
  ...
  "enterMne": "Please enter mnemonics",
  "placeholderMne": "Please enter 12-digit mnemonics separated by spaces",
  "wrongMne": "Mnemonic does not exist, please check whether mnemonic is correct",
  ...
  "wrongAddress": "Address format error",
  "addAddr": "Add address",
  ...
  "showCurrentAddress": "Display the address book under the current network",
